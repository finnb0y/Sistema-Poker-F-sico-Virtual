  ...
  return (
    <div className="h-screen flex flex-col lg:flex-row bg-[#050805]">
      ...
      <div className="lg:w-[400px] bg-[#0a0f0a] flex flex-col border-l border-white/10 p-8 space-y-6">
         ...
         <button onClick={() => onDispatch({ type: 'START_HAND', payload: { tableId: selectedTableId }, senderId: 'DEALER' })} className="w-full bg-yellow-600 hover:bg-yellow-500 text-white font-black py-10 rounded-[40px] text-2xl shadow-2xl transition-all uppercase tracking-tighter">SOLTAR MÃO</button>
